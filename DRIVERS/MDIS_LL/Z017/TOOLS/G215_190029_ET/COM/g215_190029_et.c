 ...
 */
 /*-------------------------------[ History ]--------------------------------
 *
 * $Log: g215_190029_et.c,v $
 * Revision 1.4  2011/07/08 13:20:12  dpfeuffer
 * R: 16G215-01 design-test
 * M: gpio test for 16G215-01 design-test implemented
 *
 * Revision 1.3  2011/04/04 10:40:47  dpfeuffer
 * R:1. spelling #21 G215 SERTX
 *   2. toggle frequency to slow for environment test
 * M:1. fixed to #21 G215 SERRX
 *   2. UOS_Delay( 50 ) removed from loop
 *
 * Revision 1.2  2011/03/28 11:45:40  dpfeuffer
 * R: shift is not 64-bit safe
 * M: U_INT32_OR_64 cast added
 *
 * Revision 1.1  2011/03/28 11:09:02  dpfeuffer
 * Initial Revision
 *
 *---------------------------------------------------------------------------
